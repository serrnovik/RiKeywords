...
{
    public class SequentialStreamReWriter : SequentialReWriter
    {

        // TODO Refactor after finishing play8ing to proper helper class
        private readonly Stream _stream;

        public override long Position => _stream.Position;

        public SequentialStreamReWriter(Stream stream, bool isMotorolaByteOrder = true)
        ...
        public override SequentialReader WithByteOrder(bool isMotorolaByteOrder) => 
            isMotorolaByteOrder == IsMotorolaByteOrder ? this : new SequentialStreamReWriter(_stream, isMotorolaByteOrder);
